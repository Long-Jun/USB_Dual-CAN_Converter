...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_reset(void)                                      
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_readRegister(const INT8U address)                                                                     
{
    INT8U ret;
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_readRegisterS(const INT8U address, INT8U values[], const INT8U n)
{
    INT8U i;
    mcpSPI->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_setRegister(const INT8U address, const INT8U value)
{
    mcpSPI->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_setRegisterS(const INT8U address, const INT8U values[], const INT8U n)
{
    INT8U i;
    mcpSPI->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_modifyRegister(const INT8U address, const INT8U mask, const INT8U data)
{
    mcpSPI->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_readStatus(void)                             
{
    INT8U i;
    mcpSPI->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void UTL_MCP_CAN::setSleepWakeup(const INT8U enable)
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::setMode(const INT8U opMode)
{
    mcpMode = opMode;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_setCANCTRL_Mode(const INT8U newmode)
{
...
** Descriptions:            Set control mode
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_requestNewMode(const INT8U newmode)
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_configRate(const INT8U canSpeed, const INT8U canClock)            
{
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_initCANBuffers(void)
{
    INT8U i, a1, a2, a3;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_write_id( const INT8U mcp_addr, const INT8U ext, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_write_mf( const INT8U mcp_addr, const INT8U ext, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_read_id( const INT8U mcp_addr, INT8U* ext, INT32U* id )
{
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_write_canMsg( const INT8U buffer_sidh_addr)
{
    INT8U mcp_addr;
...
*********************************************************************************************************/
void UTL_MCP_CAN::mcp2515_read_canMsg( const INT8U buffer_sidh_addr)        /* read can msg                 */
{
    INT8U mcp_addr, ctrl;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::mcp2515_getNextFreeTXBuf(INT8U *txbuf_n)                 /* get Next free txbuf          */
{
    INT8U res, i, ctrlval;
...
*********************************************************************************************************/
UTL_MCP_CAN::UTL_MCP_CAN(SPIClass *_SPI, INT8U _CS)
{
    MCPCS = _CS;
    MCP2515_UNSELECT();
    pinMode(MCPCS, OUTPUT);
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::begin(INT8U idmodeset, INT8U speedset, INT8U clockset)
{
    INT8U res;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
...
** Descriptions:            Public function to set mask(s).
*********************************************************************************************************/
INT8U UTL_MCP_CAN::init_Mask(INT8U num, INT32U ulData)
{
    INT8U res = MCP2515_OK;
    INT8U ext = 0;
#if DEBUG_MODE
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
...
** Descriptions:            Public function to set filter(s).
*********************************************************************************************************/
INT8U UTL_MCP_CAN::init_Filt(INT8U num, INT32U ulData)
{
    INT8U res = MCP2515_OK;
    INT8U ext = 0;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::setMsg(INT32U id, INT8U rtr, INT8U ext, INT8U len, INT8U *pData)
{
    int i = 0;
    m_nID     = id;
    m_nRtr    = rtr;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::sendMsgBuf(INT32U id, INT8U ext, INT8U len, INT8U *buf)
{
    INT8U res;
...
** Descriptions:            Send message to transmitt buffer
*********************************************************************************************************/
INT8U UTL_MCP_CAN::sendMsgBuf(INT32U id, INT8U len, INT8U *buf)
{
    INT8U ext = 0, rtr = 0;
    INT8U res;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::readMsgBuf(INT32U *id, INT8U *ext, INT8U *len, INT8U buf[])
{
...
** Descriptions:            Public function, Reads message from receive buffer.
*********************************************************************************************************/
INT8U UTL_MCP_CAN::readMsgBuf(INT32U *id, INT8U *len, INT8U buf[])
{
    if(readMsg() == CAN_NOMSG)
	return CAN_NOMSG;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::checkReceive(void)
{
    INT8U res;
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::checkError(void)
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::getError(void)
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::errorCountRX(void)                             
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::errorCountTX(void)                             
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::enOneShotTX(void)                             
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::disOneShotTX(void)                             
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::abortTX(void)                             
{
...
*********************************************************************************************************/
INT8U UTL_MCP_CAN::setGPO(INT8U data)
{
